...
const Index = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200"
          >
            Koronis Script Hub
          </motion.h1>
          ...
          >
            <Link 
              to="/script" 
              className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-primary/15 hover:bg-primary/25 rounded-lg border border-primary/15 transition-all duration-300 backdrop-blur-md shadow-lg"
            >
              Explore Scripts
      ...
      >
        <h2 className="text-4xl font-bold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">
          What Our Users Say
        </h2>
        <ReviewCarousel />
      </motion.div>

      <div className="py-12 border-t border-blue-400/10">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
